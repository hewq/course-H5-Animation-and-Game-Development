var OverLayer = cc.Layer.extend({
	...
	ctor: function () {
		...
		var replayLabel = new cc.LabelTTF('replay');
		replayLabel.setFontSize(size.width / 8);
		// replayLebl.setFontFillColor(cc.color.YELLOW);
		...
		// 本次成绩
		var currentScore = new cc.LabelTTF('Score:' + currentScore + 'mile');
		...
		// 最好成绩
		var bestScore = new cc.LabelTTF('Best Score:' + bestScore + 'mile');
