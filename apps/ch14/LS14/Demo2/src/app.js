var HelloWorldLayer = cc.Layer.extend({
    ...
    tiledLayerTest: function () {
        ...
        var tileGIDAt6_5 = bgLayer.getTileGIDAt(cc.p(6, 5)); // 这里指的是 TileMap 坐标系
        cc.log('tileGID = ' + tileGIDAt6_5);
        var positionAt1_1 = bgLayer.getPositionAt(1, 1);
        var tileSize = this.tiledMap.getMapSize();
        cc.log('positionAt1_1:' + positionAt1_1 + '_' + (positionAt1_1.y + tileSize.width));
    ...
    tiledObjectTest: function (tiledSize) {
        ...
        var properties = this.tiledMap.getPropertiesForGID(1); // GID 从 1 开始
