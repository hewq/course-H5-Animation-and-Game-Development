"use strict";
cc._RF.push(module, '09043v4QWBLJZtiYpN4atZy', 'UIScrollViewCanvasRenderCmd');
// frameworks/cocos2d-html5/extensions/ccui/uiwidgets/scroll-widget/UIScrollViewCanvasRenderCmd.js

"use strict";

(function () {
    if (!ccui.ProtectedNode.CanvasRenderCmd) return;
    ...
    proto.rendering = function (ctx) {
        ...
        var i,
            locCmds = cc.renderer._cacheToCanvasCmds[currentID],
            len,
        ...
        for (i = 0, len = locCmds.length; i < len; i++) {
            ...
            if (checkNode instanceof ccui.ScrollView) continue;
