"use strict";
cc._RF.push(module, '4a567gZ4mlJopDbZTAhO5MV', 'base');
// frameworks/cocos2d-html5/cocos2d/kazmath/simd_benchmark/base.js
...
Benchmarks.prototype.report = function (benchmark, outputFunctions) {
  ...
  outputFunctions.notifyResult(fillRight(benchmark.config.kernelName + ": ", 23) + "Iterations(" + fillLeft(benchmark.actualIterations, 10) + ")" + ", SIMD(" + fillLeft(benchmark.simdTime + "ms)", 8) + ", Non-SIMD(" + fillLeft(benchmark.nonSimdTime + "ms)", 8) + ", Speedup(" + ratio + ")");
