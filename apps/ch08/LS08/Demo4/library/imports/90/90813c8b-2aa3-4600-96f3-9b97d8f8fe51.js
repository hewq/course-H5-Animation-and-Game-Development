"use strict";
cc._RF.push(module, '90813yLKqNGAJbzm5fY+P5R', 'GAFAssetPreload');
// frameworks/cocos2d-html5/external/gaf/Library/GAFAssetPreload.js
...
gaf._AssetPreload.prototype.Atlases = function (asset, content, timeLine) {
    ...
    content.atlases.forEach(function (item) {
        ...
        if (!loaded) {
            var success = function success(atlas) {
                atlas.handleLoadedTexture(true);
