"use strict";
cc._RF.push(module, '31a869dVH9IY43D+asiI58g', 'XmlCheck');
// frameworks/cocos2d-html5/tools/XmlCheck.js

"use strict";

var fs = require("fs");
var path = require("path");
var modules = JSON.parse(fs.readFileSync("../moduleConfig.json"));

var contains = ["../cocos2d", "../extensions", "../external", "../Base64Images.js", "../CCBoot.js", "../CCDebugger.js"];
(function () {
    var i = 0;
    function read(name) {
...
(function () {
    ...
    for (var p in module) {
        moduleFile = moduleFile.concat(module[p].filter(function (file) {
...
xmlFile2.forEach(function (a) {
    ...
    contains.forEach(function (b) {
        if (b.indexOf(basename) > -1 && a != b) {
            if (b.indexOf("extensions") == -1 && !xmlFile2.some(function (c) {
                return b == c;
            })) console.log("     " + b);
        }
    });
