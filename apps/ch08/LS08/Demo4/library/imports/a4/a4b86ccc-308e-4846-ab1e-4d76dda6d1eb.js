"use strict";
cc._RF.push(module, 'a4b86zMMI5IRqseTXbdptHr', 'publish');
// frameworks/cocos2d-html5/tools/publish.js
...
exec("cd " + realPublishDir + " && ant", function (err, data, info) {
    ...
    externalScript = "";
    ["external/pluginx/platform/facebook_sdk.js", "external/pluginx/platform/facebook.js"].forEach(function (external) {
