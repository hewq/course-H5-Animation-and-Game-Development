"use strict";
cc._RF.push(module, '6aecbe+NFZJ95K6UipqJI9R', 'GAFSpriteCanvasRenderCmd');
// frameworks/cocos2d-html5/external/gaf/Library/GAFSpriteCanvasRenderCmd.js
...
(function () {
    ...
    proto._applyCtxState = function (gafObject) {
        ...
        if (multDirty) {
            ...
            this._hasTintMult = tintMult.r !== 255 || tintMult.g !== 255 || tintMult.b !== 255;
        }

        // Check Tint offset
        var offfsetDirty = this._tintOffset.r != tintOffset.r || this._tintOffset.g != tintOffset.g || this._tintOffset.b != tintOffset.b || this._tintOffset.a != tintOffset.a;

        if (offfsetDirty) {
            this._tintOffset = tintOffset;
            this._hasTintOffset = tintOffset.r !== 0 || tintOffset.g !== 0 || tintOffset.b !== 0 || tintOffset.a !== 0;
        }
    ...
    proto.rendering = function (ctx, scaleX, scaleY) {
        ...
        !node._texture._textureLoaded) || alpha === 0) return;
        ...
        proto._updateColor = function () {
            ...
            if (this._hasTintOffset) {
                ...
                if (locTexture && locRect.validRect && this._originalTexture) {
                    locElement = locTexture.getHtmlElementObj();
                    if (!locElement) return;
                    if (this._colorized) var texRect = cc.rect(0, 0, locRect.width, locRect.height);else texRect = locRect;
