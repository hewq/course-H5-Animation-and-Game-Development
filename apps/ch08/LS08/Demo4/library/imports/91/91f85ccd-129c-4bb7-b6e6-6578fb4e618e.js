"use strict";
cc._RF.push(module, '91f85zNEpxLt7bmZXj7TmGO', 'GAFSprite');
// frameworks/cocos2d-html5/external/gaf/Library/GAFSprite.js
...
gaf.Sprite = gaf.Object.extend({
    ...
    ctor: function ctor(gafSpriteProto, usedScale) {
    ...
    _init: function _init() {
        ...
        if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) this._sprite.setBlendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
    },
    ...
    _enableCtx: function _enableCtx() {
        this._sprite._renderCmd._enableCtx();
    },

    _disableCtx: function _disableCtx() {
        this._sprite._renderCmd._disableCtx();
    },

    _applyCtxState: function _applyCtxState(state) {
    ...
    _gafCreateRenderCmd: function _gafCreateRenderCmd(item) {
        if (cc._renderType === cc.game.RENDER_TYPE_CANVAS) return new gaf.Sprite.CanvasRenderCmd(item);else return new gaf.Sprite.WebGLRenderCmd(item);
    }
});
