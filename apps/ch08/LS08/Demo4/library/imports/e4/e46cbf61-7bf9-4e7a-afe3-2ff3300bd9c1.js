"use strict";
cc._RF.push(module, 'e46cb9he/lOeq/jL/MwC9nB', 'CCProfiler');
// frameworks/cocos2d-html5/cocos2d/core/utils/CCProfiler.js
...
cc.profiler = function () {
    ...
    var analyseFPS = function analyseFPS(fps) {
    ...
    var profiler = {
        ...
        setProfileDuration: function setProfileDuration(duration) {
            if (!isNaN(duration) && duration > 0) {
                _levelDetCycle = duration / cc.DIRECTOR_FPS_INTERVAL;
            }
        },

        resumeProfiling: function resumeProfiling() {
